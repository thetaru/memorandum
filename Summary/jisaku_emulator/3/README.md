...
### 3.1.10.3 ページテーブルの例
プログラムAやBからは0x00001000から0x003fffffまでのメモリ\*も存在するように見えますが、実際は物理メモリが割り当てられておらず、メモリ容量を消費しません。
※ 論理アドレス空間全体のことで、4GB分のメモリが割り当てられている想定です
...
```
`org 0x7c00`に対応するため、機械語プログラムの読み込み先とeipの初期値も変更します。
